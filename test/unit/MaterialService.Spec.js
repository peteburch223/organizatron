describe('MaterialService', function(){
  ...
  var tagMaterial = [{ title: 'angular article', link_url: 'www.angular.js', description: 'explaining new routes component', tags: [ {name: 'angular'}, {name: 'rails'}]}];
  ...
  beforeEach(inject(function(_MaterialService_, _MaterialFactory_, $httpBackend) {
    ...
    httpBackend
    .expectGET("http://localhost:3000/materials?tags=angular")
      .respond(tagMaterial);
  }));
